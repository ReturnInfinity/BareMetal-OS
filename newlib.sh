...
cp config.sub.patch ../../../../newlib/newlib-2.4.0/
cp configure.host.patch ../../../../newlib/newlib-2.4.0/newlib/
cp configure.in.patch ../../../../newlib/newlib-2.4.0/newlib/libc/sys/
cd ../../../../newlib
cd newlib-2.4.0
...
cp ../src/BareMetal-OS/newlib/baremetal/* newlib-2.4.0/newlib/libc/sys/baremetal/
